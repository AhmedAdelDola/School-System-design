...
class MyButton2 extends StatefulWidget {
  ...
  @override
  _MyButtonState2 createState() => _MyButtonState2();
}

class _MyButtonState2 extends State<MyButton2> {
  sqldb sqlDb = sqldb();
      ...
      children: [
        AnimatedContainer(
          ...
          child: ElevatedButton(
            ...
            child: const Text('email',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.w500,fontFamily: 'bein')),
          ),
        ),
        AnimatedOpacity(
          duration: const Duration(milliseconds: 200),
